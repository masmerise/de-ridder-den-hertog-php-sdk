...
use DeRidderDenHertog\Core\Type\CustomerId;
...
use DeRidderDenHertog\SetCustomer\SetCustomerData;
use Throwable;
...
final readonly class DeRidderDenHertog
{
     ...
     * @param FromDate|null $from The date from which to retrieve customers.
     *
     * @return Customer[]
     *
     * @throws CouldNotAuthenticate
     ...
     * @throws ValidationException
     */
    public function getCustomers(?Fields $fields = null, ?Filter $filter = null, ?FromDate $from = null): array
    {
        $response = $this->send(
     ...
     *
     * @param SetCustomerData $data The data to set.
     *
     * @return CustomerId
     *
     * @throws CouldNotAuthenticate
     ...
     * @throws ValidationException
     */
    public function setCustomer(SetCustomerData $data): CustomerId
    {
        $response = $this->send(
